  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List
        >
          {['Dashboard', 'Summary Report', 'Report Archives', 'Commission Logs'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{
              ...
              <ListItemButton>
                ...
                <ListItemText primary={text} sx={{ fontSize: { xs: '5px', md: '100px' } }} />
              </ListItemButton>
            </ListItem>
          ))}
        </List>
        ...
        <List>
          {['Wallet', 'Commission'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{
              color: 'white',
              '&:hover': {
                backgroundColor: '#5a5d6d',
        ...
        <List>
          {['Active Players', 'Deactivated'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{
              color: 'white',
              '&:hover': {
                backgroundColor: '#5a5d6d',
