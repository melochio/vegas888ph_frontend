...
export default function GameSettings() {
    ...
    const columns: GridColDef[] = [
        ...
        { field: 'gameTitle', headerName: 'Game Title', width: 200 },
        { field: 'streamId', headerName: 'Stream ID', width: 200 },
        ...
        { field: 'expfights', headerName: 'Exp Fights', width: 200 },
        {
            field: 'isActive',
            headerName: 'Action',
            flex: 1,
                ...
                <Grid item xs={12} sm={12} md={12} style={{ marginLeft: '10px' }}>
                    <Grid item xs={6} sm={6} md={12}>
                        <h3>
                            ...
                            Game Title : {selectedId > 0 ? stream.filter(e => e.id == selectedId).map(e => e.ga) : ''}
                        </h3>
                        <h3>
                        ...
                        <h3>
                            Source : {selectedId > 0 ? stream.filter(e => e.id == selectedId).map(e => e.src) : ''}   
                        </h3>
                        <h3>
                        ...
                        <h3>
                            Exp Fights :{selectedId > 0 ? stream.filter(e => e.id == selectedId).map(e => e.expfights) : ''}   
                        </h3>
                    </Grid>
                </Grid>
