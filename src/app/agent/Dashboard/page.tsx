    ...
    const handleCopyClick = async () => {
        try {
            try {
                ...
                textarea.value = window.location.origin+'/register?refCode='+user?.referral_code;
            ...
            <Grid container>
                <Grid item xs={12} sm={12} md={12}>
                    ...
                    <Container style={containerStyle} sx={{ borderTop: '6px solid red', backgroundColor: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                        ...
                        <Typography component="h6" sx={{ color: 'black', fontSize: '14px' }}>{window.location.origin+'/register?refCode='+user?.referral_code}
